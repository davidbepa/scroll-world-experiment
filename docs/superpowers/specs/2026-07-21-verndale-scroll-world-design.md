...
These values reflect Verndale's current public site. Yellow carries the connecting signal and primary actions; purple identifies the active location; lavender and white provide atmospheric space; ink carries copy and navigation.

### Art direction: Photorealistic Cinematic World
...
- The rendered environment occupies the center-right with enough negative space for copy.
...
Approved architecture: **Continuous Environmental Flight**, a frame-locked dive-and-connector chain through real locations.

- Six dive clips use the approved still as the exact opening frame, preserve its geometry, materials, and light, then move slowly forward and descend into the location.
...
- If one still drifts from the approved photorealistic style, regenerate only that still before any related video is rendered.
